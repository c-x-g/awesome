...
globalkeys = gears.table.join(awful.key({modkey}, 's', hotkeys.show_help, {description = 'show help', group = 'awesome'}),
...
awful.key({modkey}, 'r', function()
    ...
    awful.util.spawn('dmenu_run -i -fn \'Source Code Pro:bold:pixelsize=20\'')

end, {description = 'launch dmenu', group = 'launcher'}), awful.key({modkey}, 'x', function()
